...
const accesos: Acceso[] = [
  {
    titulo: "Clientes",
    descripcion: "Gestiona la base de clientes que se usa en producción.",
    href: "/admin/clientes",
    icon: (
  ...
  {
    titulo: "Pedidos",
    descripcion: "Administra los pedidos del negocio.",
    href: "/admin/pedidos",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" className="h-6 w-6">
  ...
  {
    titulo: "Despacho",
    descripcion: "Controla el estado de los pedidos del día.",
    href: "/admin/despacho",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" className="h-6 w-6">
  ...
  {
    titulo: "Usuarios",
    descripcion: "Crea usuarios y define sus permisos por módulo.",
    href: "/admin/usuarios",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" className="h-6 w-6">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
  ...
  },
  {
    ...
    descripcion: "Ajustes generales del sistema y de los módulos.",
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {accesos.map((a) => (
          <Link
            key={a.href}
            href={a.href}
            className="group flex flex-col items-start rounded-2xl border border-brand-brown/10 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-brand-amber hover:shadow-md"
          >
            <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-amber/15 text-brand-amber">
              {a.icon}
            </span>
