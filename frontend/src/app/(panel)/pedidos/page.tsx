...
export async function imprimirComanda({ punto, cliente, carrito, entrega, pago, comanda, fecha: fechaIso, valorDomicilio, vendedorNombre, vendedorCedula, id }: Pedido) {
  ...
  <style>
    *{font-family:Arial,sans-serif;color:#1a1a1a;box-sizing:border-box}
    body{width:80mm;margin:0 auto;padding:8px;font-size:12px}
    .top{display:flex;justify-content:space-between;align-items:flex-start;font-size:11px;font-weight:bold}
    .logo{text-align:center;margin:6px 0}
    .logo img{max-width:60mm;max-height:30mm;object-fit:contain}
    .logo .b{display:inline-block;background:#6b1320;color:#fff;border-radius:6px;padding:6px 14px;font-weight:bold;letter-spacing:1px}
    h1{font-size:18px;text-align:center;margin:8px 0 2px}
    .nit{text-align:left;font-size:22px;font-weight:bold;margin:6px 0 2px}
    .emp{text-align:center;font-size:12px;color:#555;margin-bottom:8px}
    .row{margin:2px 0}
    .label{font-weight:bold}
    .com{font-size:15px;font-weight:bold;margin:8px 0}
    hr{border:none;border-top:3px double #777;margin:8px 0}
    .sec{font-weight:bold;font-size:13px;margin:6px 0 4px}
    .prod{margin-bottom:8px;font-size:11px;border-bottom:3px double #777;padding-bottom:8px}
    .prod:last-child{border-bottom:none}
    .pn{font-weight:bold}
    .pn-nota{color:#444}
    .tot{font-size:16px;font-weight:bold;margin:8px 0}
    .qr{text-align:left;margin-top:10px}
    .qr img{width:35mm;height:35mm}
    .qr small{display:block;font-size:10px;color:#666;margin-top:2px}
  </style></head><body>
